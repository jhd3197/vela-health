...
2. Download this app's ZIP from [Releases](https://github.com/jhd3197/vela-health/releases/latest).
...
Stable app ID: `health`. Edit source in `health/`. Run `python release.py`
